...
namespace {
  ...
  struct SameBuf : public ModulePass {
    static char ID;
    SameBuf() : ModulePass(ID) {}    
    ...
    bool runOnModule(Module &M) override {
      ...
      // input: x and y[..] from NumKernel.out
      // x: number of kernels; 
...
char SameBuf::ID = 0;
static RegisterPass<SameBuf> X("samebuf", "do on clSetKernelArg's arguments of host code",
